...
export default function BuySharesButton() {
  return (
    <div className="buy-shares hover:bg-orange-400 py-10 mx-auto px-5 bg-orange-300 justify-center w-2/3 rounded-lg my-10 hover:scale-105 ease-in duration-300 shadow-stone-100 buy-shares" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',backgroundColor: '#FDCEDF', justifyContent: 'center' }}>
      ...
      <Link href="buy" className="buy-shares-link hover:scale-105 ease-in duration-300" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#7A3E3E', color: '#fff', padding: '10px 20px', borderRadius: '5px', textDecoration: 'none', transition: 'background-color 0.2s ease-in-out' }}>
