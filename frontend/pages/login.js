...
export default function Login() {
  ...
  return (
    <Heator>
      <div className="flex justify-center  h-screen  xl:justify-around gap-2  " style={{ backgroundColor: '#393E46' }}>
        
        <div className="mt-16 w-1/2 h-3/5  p-8 rounded-3xl" style={{ backgroundColor: '#CDE990' }}>
          <div>
